...
# Read events
listOfFiles = [
    f"/store/user/fernance/Cosmics/CosmicPPreco-PPDTLocalReco/240926_184317/0000/output_{i+1}.root"
    for i in range(547)
]
...
process.ntuples.nameOfOutput = cms.string(
    "file:/eos/user/r/rlopezru/Cosmics2024/CosmicsData_CosmicPPreco-PPDTLocalReco_Ntuples.root"
)
