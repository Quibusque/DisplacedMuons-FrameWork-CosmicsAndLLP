...
main_dir = "/eos/home-m/mcrucian/displacedCosmicsMCMini/"
...
if single_file:
    ...
    print(f"Processing single file: {listOfFiles[0]}")
else:
...
##
process.load(
    "DisplacedMuons-FrameWork-CosmicsAndLLP.Ntuplizer.Cosmics_ntuples_MiniAOD_cfi"
)
